...
Param (
    ...
    [string]$tokeneniseFile = "C:\blank.docx" # This is the file to be tokenised.
)
...
$CreateResult = Invoke-RestMethod -Method Post -Uri "https://$ApiHost$ApiBaseURL/canarytoken/factory/create" -Body $requestBody -ContentType "multipart/form-data; boundary=$httpBoundary;"
