...
os.chmod(os.path.join(TARGET_FOLDER, random_token_folder), 774)
os.chmod(os.path.join(TARGET_FOLDER, random_token_folder, random_token_sub_folder), 774)
os.chmod(token_path, 774)
